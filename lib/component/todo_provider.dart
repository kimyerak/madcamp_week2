...
class TodoProvider with ChangeNotifier {
  ...
  void setTodosForDate(DateTime date, List<Map<String, dynamic>> todos) {
    _todos[date] = todos;
    notifyListeners(); // 상태 변경을 통지
  }
  ...
  void toggleCheck(DateTime date, int index) {
    _todos[date]![index]['isChecked'] = !_todos[date]![index]['isChecked']; // 해당 항목의 체크 상태를 토글
    notifyListeners(); // 상태 변경을 통지
  }
}
